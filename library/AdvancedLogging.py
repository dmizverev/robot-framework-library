...
class AdvancedLogging():
    ...
    def _suite_folder (self):
        ...
        self._suite_folder = self.output_dir+self.sep+self.test_log_folder_name+self.sep+suite_name
        return os.path.normpath(self._suite_folder)
